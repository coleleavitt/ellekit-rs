//! Manual FFI bindings to ElleKit
//!
//! These bindings are hand-written to avoid requiring clang at build time.
//! They match the C API defined in ellekit.h
...
pub type mach_port_name_t = c_uint;
...
/// Opaque Objective-C class type
#[repr(C)]
pub struct objc_class {
    _private: [u8; 0],
}

/// Opaque Objective-C selector type
#[repr(C)]
pub struct objc_selector {
    _private: [u8; 0],
}

/// Objective-C method implementation function pointer
pub type IMP = *mut c_void;
